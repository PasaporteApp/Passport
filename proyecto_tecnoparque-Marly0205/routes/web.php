...
Route::middleware(['auth', 'role:Administrador',])->group(function () {
    Route::get('/eventoesese/{id}', [EventController::class, 'show'])->name('dedtalleseventosese');
    ...
    Route::get('metrica/stand/comentario/{standId}/{criterioId}', [MetricasController::class, 'mostrarComentarios'])->name('metrica.stand.comentario');
    });
  ...
  // RUTAS PROTEGIDAS PARA EL evento
    ...
    Route::get('/eventoese/{id}', [EventController::class, 'show'])->name('Detalleseventos');
    ...
    Route::get('/usuarios/empresasnoregistradasa', [UserController::class, 'empresasnoActivdas'])->name('empresasnoactivadas');
    Route::post('/usuarios/empresasnoactivadasas', [UserController::class, 'activarEmpresa'])->name('usuarios.activaraEmpresasa');
    ...
    Route::get('/Empresa/users/{id}/edit', [UserController::class, 'edit'])->name('Empresa.user.edits');
    Route::put('/user/{id}/updates/Empresa', [UserController::class, 'update'])->name('user.updatess');
    Route::post('/informe-a-excel/{idStand}/stand', [MetricasController::class, 'exportToExcel_satnds'])->name('informe.excel.stand');
    Route::post('/informe-a-excel/{eventId}', [MetricasController::class, 'exportToExcel'])->name('informe.excel');
    Route::get('metrica/stands/{idStand}/grafica', [MetricasController::class, 'graficastands'])->name('metrica.stands.grafica');
    Route::get('metric/stand/comentaries/{standId}/{criterioId}', [MetricasController::class, 'mostrarComentarios'])->name('metrica.stand.comentarios');
...
// RUTAS PROTEGIDAS PARA LA EMPRESA
    ...
    Route::get('/Empresa/user/{id}/edit', [UserController::class, 'edit'])->name('Empresa.user.edit');
    Route::put('/user/{id}/update/Empresa', [UserController::class, 'update'])->name('user.updates');
    Route::post('/exportar-a-excell/{idStand}/stand', [MetricasController::class, 'exportToExcel_satnds'])->name('exportar.excel.stands');
    Route::get('/empresa/index', [StandController::class, 'inicio'])->name('empresa.inicio');
    Route::get('metricas/stand/comentarios/{standId}/{criterioId}', [MetricasController::class, 'mostrarComentarios'])->name('metricas.stand.comentarios');
});
...
//CRUD de visitante
//Route::resource('user',UserController::class);
Route::get('registros', [App\Http\Controllers\UserController::class, 'create'])->name('registroes');
...
Route::get('/eventos/{id}/standses',[UserEventController::class, 'standsevento'])->name('standrelacionado');
